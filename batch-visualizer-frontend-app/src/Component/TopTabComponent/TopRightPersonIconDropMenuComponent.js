...
const TopRightPersonIconDropMenuComponent = React.forwardRef((props, ref) => {
    ...
    React.useImperativeHandle(ref, () => ({
        handleIconClick(event) {
            console.log('TopRightPersonIconDropMenuComponent handleIconClick');
        ...
        <div>
            <Menu
                ...
                transformOrigin={{
                    ...
                    <MenuItem className={classes.MenuItem} onClick={handleIconMenuClose} component={Link} to="/settings"><Settings style={{marginRight:'10px'}}/>Settings</MenuItem>
