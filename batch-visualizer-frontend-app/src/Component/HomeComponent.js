...
const useStyles = makeStyles(theme => ({
    firstContainer: {
        ...
        background: 'linear-gradient(45deg, #67b3ff 20%, #0001ff 90%)',
        // color: '#0002ff',
        // height: '700px',
    ...
    thirdContainer: {
        // flexGrow: 1,
        background: 'linear-gradient(45deg, #1e1e1e 20%, #5a5a5a 90%)',
        ...
        <div>
            ...
            <Grid container className={classes.secondContainer}> 
                ...
                <Grid item xs={12}>
                    ...
                    <img src={TpSchedulerImage} width="50%" height="50%"/>
                </Grid>
                <Grid item xs={12}>
                    <Typography className={classes.secondCommentHeader}>정산배치스케쥴러</Typography>
                    <Typography component="p" className={classes.secondComment}>
                        정산 배치프로그램의 실행 프로세스 순서 및 현황을 다이어그램 형식으로 쉽고 빠르게 확인 할 수 있습니다
                    </Typography>
                    <img src={BoSchedulerImage} width="50%" height="50%"/>
                </Grid>
            </Grid>
