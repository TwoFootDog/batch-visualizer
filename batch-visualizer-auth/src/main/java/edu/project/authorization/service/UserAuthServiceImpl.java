...
public class UserAuthServiceImpl implements UserAuthService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        List<MemberRoleVO> memberRoleList = new ArrayList<>();
        memberRoleList.add(memberVO.getMemberRole());
        User user = new User(memberVO.getUserId(), memberVO.getUserPasswd(), makeGrantedAuthority(memberRoleList));
